...
const Approve = () => {
  ...
  return (
    <S.Main>
      <S.PendingMember>
        <S.SearchBox>
          <Select items={APPROVE_STATUS} value={selectClick} onChange={setSelectClick} zIndex={1} />
          {selectClick === "ACTIVE" && <SearchBar value={memberSearch} onChange={setMemberSearch} />}
        </S.SearchBox>
        <table>
